 ...
 */
package pbo2.pkg10118067.latihan63.gradiengarislurus;
 ...
 * 10118067
 * PBO2 / IF2
 * Latihan ini berisi tentang bagaimana menyelesaikan studi kasus dengan
 * menggunakan konsep interface
 */
public class PBO210118067Latihan63GradienGarisLurus {
    ...
    public static void tampilHasil(int x1, int y1, int x2, int y2, int gradien ){
        System.out.println("Garis yang melalui titik ("+x1+","+y1+")"
                + " dan ("+x2+","+y2+") memiliki gradien sebesar "+gradien);
    }
}
